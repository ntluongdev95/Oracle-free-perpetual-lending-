...
contract BeedleToken is Ownable, ERC20, ERC20Votes,ERC20Permit("BeedleToken") {
    constructor() ERC20("Beedle", "BDL")  Ownable(msg.sender) {}
    ...
    // function nonces(address owner) internal override(ERC20Permit, Nonces) returns (uint256) {
