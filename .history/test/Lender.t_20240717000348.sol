...
contract LenderTest is Test{
    ...
    function test_CreatePool () public{
       ...
       (address poolLender, uint256 minLoanSize, uint16 maxLoanRatio, uint32 auctionLength, uint16 interestRate, uint256 poolBalance, uint256 outstandingLoans, address loanToken, address collateralToken) = lender.pools(poolId);
